<?php
/**
 * Контроллер маршрута '/shopping'
 * @package     Esthetic_CS
 */
class Esthetic_CS_Route_Prefix_Shopping implements XenForo_Route_Interface {
	...
	public function match ($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router) {
		...
		return $router->getRouteMatch('Esthetic_CS_ControllerPublic_Shopping', $action);
	}
